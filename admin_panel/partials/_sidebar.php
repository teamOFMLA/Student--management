...
<div class="sidebar">
    <a href="dashboard.php" class="logo">
        ...
        <img src="../images/logo.png">
          <div class="logo-name"><span class="text-warning">E</span><span class="darkTextColor">C</span><span class="text-warning">O</span></div>
    </a>
    ...
    <ul class="side-menu main-side-board">
       ...
       <li><a href="noticeboard.php"><i class='bx bx-bookmark'></i>Notice Board</a></li>
        ...
        <li><a href="exam.php"><i class='bx bx-exam'></i>Exam</a></li>
        <li><a href="settings.php"><i class='bx bx-cog'></i>Settings</a></li>
        <li><a href="editcard.php"><i class='bx bx-edit'></i>edit card</a></li>
