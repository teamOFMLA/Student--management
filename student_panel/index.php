...
<body>
    ...
    <div class="container">
        <aside>
            <div class="profile">
                    ...
                    <div class="info">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "
                            <p>Hey, <b>" . $row["full_name_english"] . "</b> </p>
                ...
                <div class="about">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<p><h5>الاسم : " . $row["full_name_arabic"] . "</h5></p>
                    <p>العمر : " . $row["dob"] . "</p>
                    <h5>  : الدولة</h5>
                    <p>" . $row["current_country"] . "</p>
                    <h5>     </h5>
                      <p>" . $row["whatsapp_number"] . "</p>
                    <h5>: الايميل  </h5>
                    <p>" . $row["email"] . "</p>
                    <h5>  :  العنوان  </h5>
                    <p>" . $row["address"] . "</p>";
        ...
        <main>
            ...
            <div class="subjects">
                <div class="eg " >
                    <div id="piechart"  style="display:flex; justify-content: center; align-items:center; ">   <h1 style="text-align:center;"> سيتم التواصل معك قريبا </h1></div>
...
$sql_query = "SELECT * FROM notice WHERE (role = 'student' ) OR (role = 'all' OR role='') ORDER BY s_no DESC LIMIT 3";
